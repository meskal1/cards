  ...
  return (
    <>
      <div className={s.loginContainer}>
        <h2 className={s.loginContainer__title}>sign up</h2>
          ...
          <Input
            ...
            endAdornment={
              <InputAdornment position='end'>
                <IconButton aria-label='toggle password visibility' onClick={onClickShowPassword} onMouseDown={onMouseDownPassword}>
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                ...
                size='medium'
                style={true ? { color: '#1B79CE ' } : { color: 'grey ' }} // change hardcoded
        ...
        <ButtonStyled name={'Sign in'} onClick={() => alert('Заглушка')} />
